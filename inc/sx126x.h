...
#define SX126X_RF_OUTPUT_POWER_DBM_MIN          (-9)
#define SX126X_RF_OUTPUT_POWER_DBM_MAX          22
#else
#define SX126X_RF_OUTPUT_POWER_DBM_MIN          (-17)
#define SX126X_RF_OUTPUT_POWER_DBM_MAX          15
#endif
...
typedef enum {
    ...
    SX126X_ERROR_RESET_TIMEOUT,
    SX126X_ERROR_BUSY_TIMEOUT,
    SX126X_ERROR_COMMAND_EXECUTION,
    ...
    SX126X_ERROR_HW_FUNCTION_NOT_IMPLEMENTED,
    SX126X_ERROR_BASE_GPIO = ERROR_BASE_STEP,
    SX126X_ERROR_BASE_SPI = (SX126X_ERROR_BASE_GPIO + SX126X_DRIVER_GPIO_ERROR_BASE_LAST),
